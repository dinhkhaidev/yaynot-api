...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .logo { font-size: 32px; font-weight: 700; color: #1877f2; margin-bottom: 16px; }
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="security-info">
                <div class="security-text">Link này sẽ hết hạn sau 24 giờ. Nếu bạn không tạo tài khoản này, vui lòng bỏ qua email.</div>
            </div>
        </div>
        <div class="footer">
